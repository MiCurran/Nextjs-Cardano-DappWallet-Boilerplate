...
import { Value } from "../cardano/custom_modules/@emurgo/cardano-serialization-lib-nodejs/cardano_serialization_lib";
import { IPFS_GATEWAY } from "./config";
const S = await import(
  "../cardano/custom_modules/@emurgo/cardano-serialization-lib-browser"
);
